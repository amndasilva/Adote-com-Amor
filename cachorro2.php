...
<head>
    ...
    <link rel="stylesheet" href="./src/css/cachorro2.css">
...
<body>
    ...
    <div class="container">
        ...
        <div class="animal-info">
            <img src="./src/img/Labrador.webp" alt="Animal">
            <div class="animal-details">
                <h2>Informações do Animal</h2>
                <p><strong>Nome:</strong> Bella</p>
                <p><strong>Idade:</strong> 4 anos</p>
                <p><strong>Sexo:</strong> Fêmea</p>
                <p><strong>Raça:</strong> Labrador</p>
                <p><strong>Cor da Pelagem:</strong> Preto</p>
                <p><strong>Tamanho:</strong> Porte Grande</p>
                <div class="status">
